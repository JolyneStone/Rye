...
namespace Rye.CodeGenerator.CodeGenerator.SqlServer.Tests
{
    ...
    public class TestSqlServerConnectionProvider : SqlServerConnectionProvider
    {
        ...
        {
            return GetConnectionString("RyeTestDb_Read");
        }

        protected override string GetWriteDbConnectionString()
        {
            return GetConnectionString("RyeTestDb");
        }
    }
}