...
namespace Rye.Business.Validate
{
    ...
    public class ValidateCoder
    {
        ...
        {
            FontNamesForAlphabet = new List<string> { "Arial", "Batang", "Buxton Sketch", "David", "SketchFlow Print" };
        ...
        /// 字母对应的字体名称
        /// </summary>
        public List<string> FontNamesForAlphabet { get; set; }
        ...
        public Bitmap CreateImage(string code, ValidateCodeType codeType)
        {
            ...
            for (int i = 0; i < code.Length; i++)
            {
                ...
                string fontName = codeType == ValidateCodeType.Hanzi
                    ...
                    : FontNamesForAlphabet[rnd.Next(FontNamesForAlphabet.Count)];
