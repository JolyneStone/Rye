...
namespace Rye.Security
{
    public interface ISecurityService
    {
        ...
        Task<string> EncryptAsync(int appId, string value);
        Task<string> DecryptAsync(int appId, string value);
        ...
        Task<byte[]> EncryptAsync(int appId, byte[] bytes);
        Task<byte[]> DecryptAsync(int appId, byte[] bytes);
