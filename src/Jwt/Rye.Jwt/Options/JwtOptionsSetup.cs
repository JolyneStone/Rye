    ...
    public class JwtOptionsSetup : IConfigureOptions<JwtOptions>
    {
        ...
        public void Configure(JwtOptions options)
        {
            ...
            if (options != null)
            {
                ...
                options.Issuer = options.Issuer.IsNullOrEmpty() ? "Rye Identity" : options.Issuer;
                options.Audience = options.Issuer.IsNullOrEmpty() ? "Rye Client" : options.Audience;
