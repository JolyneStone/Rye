...
namespace KiraNet.AlasFx.Jwt.Options
{
    public class JwtOptionsSetup : IConfigureOptions<JwtOptions>
    {
        ...
        public void Configure(JwtOptions options)
        {
            ...
            if (options != null)
            {
                ...
                options.Issuer = options.Issuer.IsNullOrEmpty() ? "AlasFx Identity" : options.Issuer;
                options.Audience = options.Issuer.IsNullOrEmpty() ? "AlasFx Client" : options.Audience;
