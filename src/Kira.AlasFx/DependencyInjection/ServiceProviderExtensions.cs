...
namespace Kira.AlasFx.DependencyInjection
{
    public static class ServiceProviderExtensions
    {
        ...
        /// <returns></returns>
        public static AlasFxOptions AlasFxOptions(this IServiceProvider provider)
        {
            return provider.GetRequiredService<IOptions<AlasFxOptions>>()?.Value;
        }
