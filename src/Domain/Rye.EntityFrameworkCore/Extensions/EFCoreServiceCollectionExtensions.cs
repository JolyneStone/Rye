...
namespace Rye
{
    public static class EFCoreServiceCollectionExtensions
    {
        ...
        /// <param name="action"></param>
        /// <returns></returns>
        public static IServiceCollection AddDbBuillderOptions(this IServiceCollection services, Action<RyeDbContextOptionsBuilder> action)
        {
            if (action is null)
            {
            ...
            var builder = new RyeDbContextOptionsBuilder();
            action?.Invoke(builder);
