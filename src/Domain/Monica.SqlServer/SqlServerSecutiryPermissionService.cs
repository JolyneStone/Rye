...
{
    public class SqlServerSecutiryPermissionService : ISecutiryPermissionService
    {
        private readonly IConnectionProvider _connectionProvider;
        public SqlServerSecutiryPermissionService(IConnectionProvider connectionProvider)
        {
