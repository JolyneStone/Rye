...
namespace Monica.EntityFrameworkCore
{
    public class DbProvider : IDbProvider
    {
        ...
        //        {
        //            throw new MonicaException("无法获取匹配的DbContextOptionsBuilder");
        //        }
        ...
        //        if (dbUser == null)
        //        {
        //            throw new MonicaException($"无法解析类型为“{dbConnectionOptions.DatabaseType}”的 {typeof(IDbContextOptionsBuilderUser).FullName} 实例");
        //        }
        ...
        //            {
        //                throw new MonicaException("无法获取有效的上下文构造器");
        //            }
            ...
            where TDbContext : DbContext, IDbContext
        {
            ...
            public static IUnitOfWork GetUnitOfWork(IServiceProvider serviceProvider, string dbName = null)
            {
                ...
                if (_factory == null)
                {
                    ...
                    {
                        throw new MonicaException("无上下文构造器");
                    }
